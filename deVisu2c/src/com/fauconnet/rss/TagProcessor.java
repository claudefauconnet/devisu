...
public class TagProcessor implements I_Processor {
	...
	public String process(Map params) {
		List<DBObject> rssItems = (List<DBObject>) params.get("data");
		int nFeeds=rssItems.size();
		...
		if (method.equals("getTags")) {
			...
			for (DBObject rssItem : rssItems) {
				text.append(rssItem.get("title") + "\n");
			}
	...
	public TagProcessor(int maxTags, int classesNb, String excludedWords) {
		this.maxTags = maxTags;
	...
	private static void main(String[] args) {
		...
		TagProcessor cloud = new TagProcessor();
